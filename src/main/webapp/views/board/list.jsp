...
<body>
	<div class="container content-area">
		<div class="content-title">
			<h2 onclick="location.href='${contextPath}/board/list.bo?page=1';">게시판 목록</h2>
		</div>
		<div>
			<div class="table-responsive-xl" style="text-align: right;">
			  <div style="display: flex;" class="d-flex justify-content-end content-area-header">
	  			...
	  			<a href="${contextPath}/board/regist.bo" class="btn btn-info btn-sm">글작성</a>
			  </div>
			  ...
			  <!-- 페이징 영역 -->
			   <ul class="pagination justify-content-center">
				  <c:choose>
				  	...
				  	<c:otherwise>
				  		<li class="page-item"><a class="page-link" href="${contextPath}/board/list.bo?page=${page.currentPage -1}">&lt;</a></li>
				  	</c:otherwise>
				  </c:choose>
				  ...
				  <c:forEach var="p" begin="${page.startPage}" end="${page.endPage}">
					  <c:choose>
					  	...
					  	<c:otherwise>
					  		<li class="page-item"><a class="page-link" href="${contextPath}/board/list.bo?page=${p}">${p}</a></li>
					  	</c:otherwise>
					  </c:choose>
				  </c:forEach>
	...
	<script>
		...
		function clickTableRow(){
			...
			$('#boardList>tbody>tr').on('click', function() {
	            location.href = '${contextPath}/board/detail.bo?no=' + $(this).children().eq(0).text();
	        });
		};
	   ...
	   $(function(){
		   ...
		   clickTableRow();
			...
			$('#searchBtn').click(function(){
				...
				// 검색 버튼 클릭시 ajax 
				$.ajax({
					url: '${contextPath}/board/listSearch.bo',
					...
					success: function(resultMap){
			            ...
			            if (resultMap.page) {
			                ...
			                if(page.currentPage == 1){ // 현재 사용자가 보고 있는 페이지가 1페이지일때
			                    ...
			                    pageArea += '<li class="page-item"><a class="page-link" href="${contextPath}/board/list.bo?page=' + (page.currentPage - 1) + '">&lt;</a></li>';
			                }
			                ...
			                for(let p = page.startPage; p <= page.endPage; p++) {
			                    if(p == page.currentPage){
			                        ...
			                        pageArea += '<li class="page-item"><a class="page-link" href="${contextPath}/board/list.bo?page=' + p + '">' + p + '</a></li>';
			                    }
			                }
