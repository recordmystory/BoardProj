...
<body>
	<div class="container content-area">
		...
		<form action="${contextPath}/insert.bo" method="post">
			<div>
				제목 <input type="text" class="form-control" name="title" style="width: 800px; margin-bottom: 15px;" value="${not empty sessionScope.enteredTitle ? request.enteredTitle : ''}" required>
				내용 <textarea class="form-control" name="content" style="white-space: pre; resize: none; height: 500px;" required>${not empty sessionScope.enteredContent ? request.enteredContent : ''}</textarea>
				<div class="btnArea">
